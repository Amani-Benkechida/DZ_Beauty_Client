...
import Prestataires from './presAdmin';
const Sidebaradmin = () => {
  ...
  const sections = [
    ...
    { name: 'Prestataires List', label: 'add Prestataires' },
    {name:'prestataireslist', label: 'Prestataireslist'},
    ...
    <div className=''>
      ...
      <div className="fix rounded-md">
        <div className="flex  shadow-2xl mb-3 shadow-gray-400 h-auto rounded-md">
          ...
          {What === 'prestataireslist' &&<Prestataires/>}
          </div>
        </div>
      </div>
    </div>
